...
namespace Alaska.Foundation.Extensions.Logging.Middleware
{
    public class SerilogMiddleware
    {
        protected const string MessageTemplate = "HTTP {RequestMethod} {RequestPath} responded {StatusCode} in {Elapsed:0.0000} ms";

        protected static readonly ILogger Log = Serilog.Log.ForContext<SerilogMiddleware>();
