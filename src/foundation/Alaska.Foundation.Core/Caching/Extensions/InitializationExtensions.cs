...
using Alaska.Foundation.Core.Caching.Instances;
...
namespace Alaska.Foundation.Core.Caching.Extensions
{
    public static class InitializationExtensions
    {
        public static IServiceCollection AddFilesCache(this IServiceCollection services)
        {
            return services.AddMemoryCacheInstance<FilesCache>();
        }
